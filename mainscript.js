if (navigator.userAgent.match(/Android/i)) {
    ...
    $(document).ready(function(){
        $(".lazyloading-paging").css("display","block");
        $(".new_box .new_link p").each(function(){
            if( $.trim($(this).text()) == "" ){
                $(this).hide();
            }
        });
    ...
    ddsmoothmenu.init({
        ...
        ddsmoothmenu.init({
    	mainmenuid: "smoothmenu1_vertical", //menu DIV id
    	orientation: 'v', //Horizontal or vertical menu: Set to "h" or "v"
    	classname: 'ddsmoothmenu_vertical', //class added to menu's outer DIV
    	//customtheme: ["#1c5a80", "#18374a"],
    	contentsource: "markup" //"markup" or ["container_id", "path_to_menu_file"]
    });
